...
const HINDI_2_LETTER = ['अब','अम','कल','घर','जल','नल','दल','पल','बम','रथ','वन','हम'];
const HINDI_3_LETTER = ['कमल','अमर','सड़क','नमक','कलम','सफल','अजय','अचल','चमक','दमक'];
const HINDI_4_LETTER = ['अनार','अमरूद','इमली','कबूतर','मगरमच्छ','हाथी','बिल्ली','तितली'];
